...
const languages = [
    ...
    { code: 'eml', name: '艾米利亚-罗马涅语', flag: '🇮🇹', nativeName: 'Emiliàn e rumagnòl' },
    ...
    { code: 'ext', name: '埃斯特雷马杜拉语', flag: '🇪🇸', nativeName: 'Estremeñu' },
    ...
    { code: 'stq', name: '萨尔特兰弗里西亚语', flag: '🇩🇪', nativeName: 'Seeltersk' },
    ...
    { code: 'osp', name: '古西班牙语', flag: '🇪🇸', nativeName: 'Español medieval' },
    { code: 'osp', name: '古葡萄牙语', flag: '🇵🇹', nativeName: 'Português medieval' },
    ...
    { code: 'cai', name: '中美洲印第安语', flag: '🇲🇽', nativeName: 'Central American Indian' },
    { code: 'sai', name: '南美洲印第安语', flag: '🇧🇷', nativeName: 'South American Indian' },
    { code: 'nai', name: '北美洲印第安语', flag: '🇺🇸', nativeName: 'North American Indian' },
    { code: 'map', name: '南岛语', flag: '🇵🇭', nativeName: 'Austronesian' },
    { code: 'paa', name: '巴布亚语', flag: '🇵🇬', nativeName: 'Papuan' },
    { code: 'aus', name: '澳大利亚原住民语', flag: '🇦🇺', nativeName: 'Australian Aboriginal' },
    ...
    { code: 'mul', name: '多种语言', flag: '🌍', nativeName: 'Multiple languages' },
    { code: 'zxx', name: '无语言内容', flag: '🚫', nativeName: 'No linguistic content' },
    { code: 'mis', name: '未编码语言', flag: '❓', nativeName: 'Uncoded language' }
];
...
function setupEventListeners() {
    // 语言选择
    elements.sourceLanguageBtn.addEventListener('click', () => toggleLanguageMenu('source'));
    elements.targetLanguageBtn.addEventListener('click', () => toggleLanguageMenu('target'));
    ...
    elements.speakSource.addEventListener('click', () => speakText(appState.sourceText, appState.sourceLanguage));
    elements.speakTranslation.addEventListener('click', () => speakText(appState.translatedText, appState.targetLanguage));
...
function toggleLanguageMenu(type) {
    const menu = type === 'source' ? elements.sourceLanguageMenu : elements.targetLanguageMenu;
    const otherMenu = type === 'source' ? elements.targetLanguageMenu : elements.sourceLanguageMenu;
...
function updateLanguageButton(type, langCode) {
    ...
    const btn = type === 'source' ? elements.sourceLanguageBtn : elements.targetLanguageBtn;
...
function swapLanguages() {
    ...
    elements.translatedText.innerHTML = appState.translatedText || `
...
function handleOutsideClick(event) {
    ...
    if (!event.target.closest('.modal-content') && !event.target.closest('.btn-settings')) {
        elements.settingsModal.classList.remove('show');
    }
}
...
chrome?.runtime?.onMessage?.addListener?.((message) => {
    if (message && message.type === 'FORWARD_SELECTION_TO_PANEL' && typeof message.text === 'string') {
